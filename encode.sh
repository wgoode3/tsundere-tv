...
# ffmpeg -re -i "/home/streamer/Videos/[HorribleSubs]_Darling_in_the_FranXX_-_01_[1080p].mkv" -c:a aac -ac 2 -b:a 128k -strict -2 -c:v libx264 -pix_fmt yuv420p -profile:v baseline -preset fast -tune zerolatency -vsync cfr -x264-params "nal-hrd=cbr" -vf subtitles="/home/streamer/Videos/\[HorribleSubs\]_Darling_in_the_FranXX_-_01_\[1080p\].mkv" -b:v 2000k -minrate 2000k -maxrate 2000k -bufsize 4000k -s 1280x720 -f flv "rtmp://127.0.0.1/dash/test_med" -y

# -vf subtitles='/media/sf_shared/[HorribleSubs]_Darling_in_the_FranXX_-_01_[1080p].mkv'